<div class="main-contents">
    ...
    <div class="table-wrapper">
        <div class="table-container">
            ...
            <div class="table-header bordered-bottom">
                <h3 class="table-title">Youth Volunteers Management</h3> 
            </div>
            ...
            <div class="table-header table-header-2">
                ...
                <div class="top-buttons">
                    ...
                    @if($active_status === 1)
                        <span class="table-notif-counter" style="background-color: {{ count($deactivatedVolunteers) > 0 ? 'red' : 'rgb(245, 245, 245)' }}">{{ count($deactivatedVolunteers) }}</span>
                    @endif
                </div> 
            </div>
                                ...
                                <div class="secondary-data @if(!in_array($volunteer->id, $expandedRows)) display-none @endif">
                                    ...
                                    <div class="data-row center on-mobile @if(!in_array($volunteer->id, $expandedRows)) display-none @endif">
                                        @if(Auth::user()->user_role !== 'vsa')
                                            ...
                                            @if($active_status === 2)
                                                <div class="table-btn-g w-35">
                                                    <button class="open-dialog-btn btn-success" wire:click="reactivateDialog('{{ $volunteer->user_id }}')" wire:loading.attr="disabled"><i class="bi bi-person-check"></i>
                                                    </button>
                                                    <p class="hover-p-2">Activate</p>
                                                </div>
                                            @else
                                                <div class="table-btn-g w-35">
                                                    <button class="open-dialog-btn btn-warning" wire:click="deactDialog('{{ $volunteer->user_id }}')" wire:loading.attr="disabled"><i class="bi bi-ban"></i>
                                                    </button>
                                                    <p class="hover-p-2">Deactivate</p>
                                                </div>
                                                <div class="table-btn-g w-35">
                                                    <button class="open-dialog-btn btn-delete" wire:click="deleteDialog('{{ $volunteer->user_id }}')" wire:loading.attr="disabled"><i class="bi bi-trash3"></i>
                                                    </button>
                                        ...
                                        @else
                                            <button class="btn-success" wire:click="exportToPdf" wire:loading.attr="disabled">
                                                <span wire:loading.remove><i class="bi bi-filetype-pdf"></i></span>
                                                <div wire:loading wire:target="exportToPdf" class="loading-container">
                                                    <div class="loading-spinner"></div>
                                                </div>
                                            </button>
    ...
    <div class="popup popup-modal" @if(!$deleteVolunteerId) style="display: none;" @endif>
        ...
        <div class="popup-modal-content">
            ...
            <div class="modal-footer">
                @if($disableButton == "No")
                    <button class="close-dialog-btn btn-delete" wire:click="deleteVolunteer('{{ $deleteVolunteerId }}')" wire:loading.attr="disabled">Yes</button>
    ...
    <div class="popup popup-modal" @if(!$deactVolunteerId) style="display: none;" @endif>
        ...
        <div class="popup-modal-content">
            ...
            <div class="modal-header">
                ...
                <button type="button" class="close-dialog-btn close" aria-label="Close" wire:click="hideDeleteDialog">
    ...
    <div class="popup popup-modal" @if(!$reactivateVolunteerId) style="display: none;" @endif>
        ...
        <div class="popup-modal-content">
            ...
            <div class="modal-footer">
                @if($disableButton == "No")
                    <button class="close-dialog-btn btn-success" wire:click="reactivateVolunteer('{{ $reactivateVolunteerId }}')" wire:loading.attr="disabled">Yes</button>
