                ...
                @if(session('user_role') == 'yip')
                    ...
                    <li class="nav-item">
                        <a href="{{ route('past-ip-participated-events') }}" class="nav-link {{ request()->routeIs('past-ip-participated-events') ? 'active' : '' }}" wire:navigate>
                            ...
                            <p>Past Participated IP Events</p>
                        </a>
                    </li>
