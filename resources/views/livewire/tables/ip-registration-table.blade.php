<div class="main-contents">
    ...
    <div class="table-wrapper">
        <div class="table-container">
                ...
                <div class="table-header bordered-bottom">
                    <h3 class="table-title">IP Registrations Management</h3>
                </div>
                        ...
                        @foreach($volunteers as $volunteer)
                            ...
                            <div class="table-tr" wire:key="volunteer-{{ $volunteer->id }}" style="height: @if(in_array($volunteer->id, $expandedRows)) fit-content @else 90px @endif;">
                                ...
                                <div class="tr" wire:click="toggleRow('{{ $volunteer->id }}')">
                                    ...
                                    <div class="secondary-data @if(!in_array($volunteer->id, $expandedRows)) display-none @endif">
                                        ...
                                        <div class="data-row center on-mobile @if(!in_array($volunteer->id, $expandedRows)) display-none @endif">
                                            ...
                                            <div class="table-btn-g w-35">
                                                <button class="open-dialog-btn btn-delete" wire:click="redflagDialog('{{ $volunteer->user_id }}')">
                                                    <i class="bi bi-flag-fill"></i>
                                                </button>
                                                <span class="hover-p-2">Red&nbspFlag</span>
                                            </div>
                                ...
                                <div class="table-action-buttons">
                                    ...
                                    <div class="mx-2"></div>
                                    <div class="table-btn-g">
                                        <button class="open-dialog-btn table-action-button t-a-b-danger" wire:click="redflagDialog('{{ $volunteer->user_id }}')">
                                            <i class="bi bi-flag-fill"></i>
                                        </button>
    ...
    <div class="popup popup-modal" @if(!$deleteRegistrantId) style="display: none;" @endif>
        ...
        <div class="popup-modal-content">
            ...
            <div class="modal-footer">
                @if($disableButton == "No")
                    <button class="close-dialog-btn btn-delete" wire:click="deleteRegistrant('{{ $deleteRegistrantId }}')" wire:loading.attr="disabled">Yes
                    </button>
    ...
    <div class="popup popup-modal" @if(!$redflagRegistrantId) style="display: none;" @endif>
        <div class="close-dialog-btn modal-overlay" wire:click="hideDeleteDialog"></div>
        <div class="popup-modal-content">
            ...
            <div class="modal-footer">
                @if($disableButton == "No")
                    <button class="close-dialog-btn btn-delete" wire:click="redflagRegistrant('{{ $redflagRegistrantId }}')" wire:loading.attr="disabled">Yes
                    </button>
                    <button class="close-dialog-btn btn-cancel" wire:click="hideDeleteDialog">Cancel</button>
                @else
                    <button class="close-dialog-btn btn-cancel" wire:click="hideDeleteDialog">Close</button>
